...
class AppleInAppPurchaseVerification
{
	...
	{
		if ($this->password == '') {
			return json_encode(array('receipt-data' => $this->receiptData));
		} else {
			return json_encode(array('receipt-data' => $this->receiptData, 'password' => $this->password));
		}
	}
